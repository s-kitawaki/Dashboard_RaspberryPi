...
// Memetchi follows the 31x32 grid of its reference bead chart (35 rows with feet and shadow): a hollow swirl on top,
// a wide orange head with two bangs, big eyes with a white plus, and a small body. '.' transparent, n navy, o orange, w white.
const MEMETCHI_PALETTE = { n: NAVY, o: '#f2a93b', w: '#ffffff' }
const memetchi: Sprite = {
  name: 'memetchi', label: 'めめっち', width: 31, height: 35,
  body: gridToLayers([
    '.............nnnn..............',
    '...........nn....nn............',
    '..........n........n...........',
  ...
  eyesClosed: [{ fill: NAVY, rects: [[7, 19, 6, 1], [17, 19, 6, 1]] }],
  feet: { outline: NAVY, fill: '#f2a93b' },
  feetLeft: [{ fill: NAVY, rects: [[12, 31, 2, 2]] }],
  feetRight: [{ fill: NAVY, rects: [[17, 31, 2, 2]] }],
  shadow: [[10, 33, 11, 1]],
  zzz: ZZZ,
}
